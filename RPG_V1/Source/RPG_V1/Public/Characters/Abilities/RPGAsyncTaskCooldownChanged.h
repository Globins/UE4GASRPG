...
#include "RPGAsyncTaskCooldownChanged.generated.h"
...
class RPG_V1_API URPGAsyncTaskCooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static URPGAsyncTaskCooldownChanged* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags, bool UseServerCooldown);
