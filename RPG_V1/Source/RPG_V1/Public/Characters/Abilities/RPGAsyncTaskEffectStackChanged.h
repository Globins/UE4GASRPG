...
#include "RPGAsyncTaskEffectStackChanged.generated.h"
...
class RPG_V1_API URPGAsyncTaskEffectStackChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static URPGAsyncTaskEffectStackChanged* ListenForGameplayEffectStackChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTag EffectGameplayTag);
