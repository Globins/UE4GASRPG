...
#include "Characters\Abilities\RPGDamageExeCalculation.h"
...
struct GDDamageStatics
{
	...
	GDDamageStatics()
	{
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(URPGAttributeSetBase, Damage, Source, true);
...
URPGDamageExeCalculation::URPGDamageExeCalculation()
{
	RelevantAttributesToCapture.Add(DamageStatics().DamageDef);
	RelevantAttributesToCapture.Add(DamageStatics().ArmorDef);
}

void URPGDamageExeCalculation::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, OUT FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
