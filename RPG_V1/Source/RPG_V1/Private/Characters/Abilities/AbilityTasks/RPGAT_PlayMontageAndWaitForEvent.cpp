...
#include "Characters\Abilities\AbilityTasks\RPGAT_PlayMontageAndWaitForEvent.h"
...
void URPGAT_PlayMontageAndWaitForEvent::Activate()
{
	...
	if (RPGAbilitySystemComponent)
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			EventHandle = RPGAbilitySystemComponent->AddGameplayEventTagContainerDelegate(EventTags, FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this, &URPGAT_PlayMontageAndWaitForEvent::OnGameplayEvent));
...
URPGAT_PlayMontageAndWaitForEvent* URPGAT_PlayMontageAndWaitForEvent::PlayMontageAndWaitForEvent(UGameplayAbility* OwningAbility, FName TaskInstanceName, UAnimMontage* MontageToPlay, FGameplayTagContainer EventTags, float Rate, FName StartSection, bool bStopWhenAbilityEnds, float AnimRootMotionTranslationScale)
{
	UAbilitySystemGlobals::NonShipping_ApplyGlobalAbilityScaler_Rate(Rate);

	URPGAT_PlayMontageAndWaitForEvent* MyObj = NewAbilityTask<URPGAT_PlayMontageAndWaitForEvent>(OwningAbility, TaskInstanceName);
