...
#include "Characters/NonPlayer/RPGNonPlayerCharacterBase.h"
...
ARPGNonPlayerCharacterBase::ARPGNonPlayerCharacterBase(const class FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void ARPGNonPlayerCharacterBase::BeginPlay()
{
	Super::BeginPlay();
	...
	if (IsValid(AbilitySystemComponent))
	{
		...
		AbilitySystemComponent->RegisterGameplayTagEvent(FGameplayTag::RequestGameplayTag(FName("State.Debuff.Stun")), EGameplayTagEventType::NewOrRemoved).AddUObject(this, &ARPGNonPlayerCharacterBase::StunTagChanged);
	}
}

void ARPGNonPlayerCharacterBase::StunTagChanged(const FGameplayTag CallbackTag, int32 NewCount)
{
	if (NewCount > 0)
	{
